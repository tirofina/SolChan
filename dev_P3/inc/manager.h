...
class Manager{
    ...
    private:
        ...
        int take_order(std::string coffee,std::string name){return _store.take_order(coffee,name);};
        int take_order(std::string coffee,std::string name,int point){return _store.take_order(coffee,name,point);};
